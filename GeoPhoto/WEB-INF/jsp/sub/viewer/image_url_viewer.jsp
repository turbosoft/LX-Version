...
<!-- <div id='exif_dialog' style='position:absolute; left:800px; top:310px; width:300px; height:200px; border:1px solid #999999; display:block; font-size:13px;'> -->
	<div class="viewer_info_class" style="position:absolute; left:781px; top:0px; width:352px; display:block; font-size:13px; height: 30px; border-bottom : 1px solid #ebebeb;">
		...
		<button id="exifViewOff" class="smallWhiteBtn" onclick="exifViewFunction('off');" style="display:none; float: right;height:25px; margin: 5px 10px;" align="center">HIDE</button>
		<button id="exifViewOn" class="smallWhiteActiveBtn" onclick="exifViewFunction('on');" style="display:block;height:25px;float: right;margin: 5px 10px;" align="center">SHOW</button>
	</div>
