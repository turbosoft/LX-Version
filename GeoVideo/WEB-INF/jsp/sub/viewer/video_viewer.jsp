...
function imageControllView(type){
	...
	if(type == 'Y'){
		...
		var tmpDiv = '<div id="grayDivArea" style="position:absolute; width:100%; height:585px; background:gray; opacity:0.5; left:0; top:0;" ></div>';
		$('body').append(tmpDiv);
...
// 	console.log('time : ' + time + ' gps_size : ' + gps_size + ' totaltime :'+ totaltime + ' ratio : ' + ratio);
	if(gps_size > 0){
		$('#openlayers').get(0).contentWindow.moveMarker(parseInt(time));
	}else{
...
<!-- 비디오 영역 -->
<div id='video_main_area' style='position:absolute; left:0px; top:0px; width:770px; height:580px; display:block; border-right:1px solid #ebebeb; overflow: hidden;'>
...
<!-- 	</div> -->
<!-- </div> -->
<div style="width:1143px; height: 205px; margin: 585px 0 0 -10px;background:#1e2b41;">
	<div id="image_view_group" style="color:#ffffff; font-size: 16px; position: absolute; top:592px; left:10px; width:1110px; height: 38px;"></div>
	...
	<div id='img_move_area' style='position:absolute; left:10px; top:620px; width:1115px; height:160px; display:block; overflow-y:hidden;'>
...
<!-- 지도 영역 -->
<div id='video_map_area' style='position: absolute;left: 781px;top: 31px;width: 352px;height: 549px;display: block;z-index: 1;'>
...
<div id="copyUrlBtn" class="smallGreyBtn" style="width: 60px;height: 20px;float: right;border-radius:5px;text-align: center;position: absolute;top: 470px;left: 670px;cursor: pointer;font-size: 13px;">copy URI</div>
...
<div onclick='iframeSrcView();' class="smallWhiteBtn" style='width: 90px;height: 20px;float: right;border-radius:5px;text-align: center;position: absolute;top: 470px;left: 540px;cursor: pointer;font-size: 13px;'>Source Code</div>
