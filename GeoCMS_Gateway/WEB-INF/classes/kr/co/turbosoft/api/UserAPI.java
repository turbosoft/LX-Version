...
public class UserAPI {
	...
	public void setDataDao(DataDao dataDao){
		UserAPI.dataDao = dataDao;
	}
	
	public void setDataAPI(DataAPI dataAPI){
		UserAPI.dataAPI = dataAPI;
	}
...
//				}
	...
	//search share user
	@RequestMapping(value = "/cms/getShareUser/{token}/{loginId}/{shareIdx}/{shareType}/{flag}", method = RequestMethod.GET, produces="application/json;charset=UTF-8")
	@ResponseBody
	public String searchUserService(@RequestParam("callback") String callback
			, @PathVariable("token") String token
			, @PathVariable("loginId") String loginId
