...
//	}
	...
	public int insertTraj(HashMap<String, String> param) {
		...
		resultIntegerValue = getSqlSession().insert("data.insertTraj", param);
	...
	public int insertSensor(HashMap<String, String> param) {
		...
		resultIntegerValue = getSqlSession().insert("data.insertSensor", param);
	...
	public String analysisExecute(HashMap<String, String> param) {
		// TODO Auto-generated method stub
		resultStringValue = getSqlSession().selectOne("data.analysisExecute", param); 
	...
	@Override
	public List<HashMap<String, Object>> selectDataList(HashMap<String, Object> param) {
		// TODO Auto-generated method stub
		List<HashMap<String, Object>> newResultList = getSqlSession().selectList("data.selectDataList", param);
	...
	public List<Map<String, String>> selectJsonData(HashMap<String, String> param) {
		// TODO Auto-generated method stub
		return getSqlSession().selectList("data.selectJsonData", param);
	}

	@Override
	public List<HashMap<String, Object>> selectDataList(Map<String, Object> commandMap) {
		List<HashMap<String, Object>> newResultList = getSqlSession().selectList("data.selectDataList", commandMap);
		return newResultList;
	}
	...
	public List<HashMap<String, Object>> selectImageDataList(Map<String, Object> commandMap) {
		// TODO Auto-generated method stub
		return getSqlSession().selectList("data.selectImageDataList", commandMap);
	}

	@Override
	public List<HashMap<String, Object>> selectVideoDataList(Map<String, Object> commandMap) {
		// TODO Auto-generated method stub
		return getSqlSession().selectList("data.selectVideoDataList", commandMap);
	}

	@Override
	public void insertImageData(Map<String, Object> selectImageMap) {
		// TODO Auto-generated method stub
		getSqlSession().insert("data.insertImageData", selectImageMap);
	}

	@Override
	public void insertVideoData(Map<String, Object> selectVideoMap) {
		// TODO Auto-generated method stub
		getSqlSession().insert("data.insertVideoData", selectVideoMap);
	}
	
	public List<Map<String, String>> selectAllLayer() {
		// TODO Auto-generated method stub
		return getSqlSession().selectList("data.selectAllLayer");
	}
	
	public String selectTypeName(Map<String, String> param)
	{
		// TODO Auto-generated method stub
		return getSqlSession().selectOne("data.selectTypeName", param);
	}
	public String selectJsonResultData(HashMap<String, String> param)
	{
		// TODO Auto-generated method stub
		return getSqlSession().selectOne("data.selectJsonResultData", param);
	}
	public String selectTabName(Map<String, String> param)
	{
		// TODO Auto-generated method stub
		return getSqlSession().selectOne("data.selectTabName", param);
	}
