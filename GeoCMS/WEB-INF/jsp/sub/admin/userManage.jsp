...
<body bgcolor="#FFF">
	<table id='manage_table'>
		<tbody>
			<tr>
				...
				<button style="border-radius: 2px; border: none; font-size: 14px; padding: 5px 10px; display: inline-block; background: #297ACC; color: white;" onclick='clickUserPage(1);'>SEARCH</button>
	...
	<div style="text-align:center;">
		<button style="border-radius: 2px;margin: 7px; border: none; font-size: 14px;padding: 9px 15px; display: inline-block; background:#297ACC; color:white;" onclick='userTypeSave();'>SAVE</button>
		<button style="border-radius: 2px;margin: 7px; border: none; font-size: 14px;padding: 9px 15px; display: inline-block; background:#6E778A; color:white;" onclick='manageClose();'>CANCEL</button>
	</div>
</body>
