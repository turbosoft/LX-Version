...
function serverDataSetDef_1(){
	serverTblCnt++;
	var htmlStr = '';
	htmlStr += '<table id="serverTbl_'+ serverTblCnt +'" class="serverTblClass" style="width:100%; margin-top:10px; background:#F2F3F5;">';
	htmlStr += 	'<tr>';
	...
	htmlStr += 		'</td>';
	htmlStr += 		'<td rowspan="2" style="width:67px; vertical-align:top; padding-top:4px;">';
	htmlStr += 			'<button onclick="serverModify('+ serverTblCnt +',true);" id="serverMoBtn_'+ serverTblCnt +'" class="serverMoClass" style="width:65px; border-radius: 2px; border: none; font-size: 12px; padding: 5px 10px; display: inline-block; background: #6D808F; color: white;">Modify</button>';
	htmlStr += 			'<button onclick="serverUpdate('+ serverTblCnt +',\'U\');" id="serverUpBtn_'+ serverTblCnt +'" style="display:none; width:65px; border-radius: 2px; border: none; font-size: 12px; padding: 5px 10px; display: inline-block; background: #6D808F; color: white;" class="serverUpClass">Update</button>';
	htmlStr += 			'<button onclick="serverAddCenCle('+ serverTblCnt +');" id="serverCnBtn_'+ serverTblCnt +'" style="display:none; width:65px; margin-top:11px; border-radius: 2px; border: none; font-size: 12px; padding: 5px 10px; display: inline-block; background: #6D808F; color: white;" class="serverCnClass">Cancel</button>';
	htmlStr += 		'</td>';
	htmlStr += 	'</tr>';
	htmlStr += 	'<tr>';
	htmlStr += 		'<th style="width:120px; text-align:left;">';
