...
<!-- <script type="text/javascript" src="http://map.vworld.kr/js/vworldMapInit.js.do?&apiKey=393E3826-9B75-3E91-8E63-B0DBD7177C1A"></script> -->
<script type="text/javascript" src="http://map.vworld.kr/js/vworldMapInit.js.do?&apiKey=FB106A62-A791-3EE5-8B7B-5DBC8B408273"></script>
	...
	if(map != null){
		...
		vworld.init("map", "map-first", 
		    function() {        
		        ...
		        map.setCenterAndZoom(14243425.793355, 4342305.8698004, 8);//화면중심점과 레벨로 이동 (초기 화면중심점과 레벨)
				if(typeShape == "marker") {	//main marker
					takeMarkerData(typeShape);
				}
				else if(typeShape == "forSearch") {	//searh page marker
...
function fnMakeMarker(p, type){ //lat, lon, filename, idx, kind, origin , thumbnail , id, projectUserId, projectMarkerIcon  
	var point = map.getTransformXY(p[1], p[0], "EPSG:4326","EPSG:900913");
