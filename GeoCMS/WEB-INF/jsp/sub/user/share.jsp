...
<body bgcolor="#FFF">
		...
		<tbody>
			<tr>
				<td colspan="2">
					...
					<button style="border-radius: 2px; border: none; padding: 5px 10px; display: inline-block; background: #297ACC; color: white;" onclick='clickUserPage("search", 1);'>search</button>
					<button onclick='shareUserRemove();' style="float: right; border-radius: 2px; border: none;  padding: 5px 10px; display: inline-block; background: #6D808F; color: white;">remove</button>
				</td>
			</tr>
		</tbody>
	</table>
	...
	<table id='shareUser_table' style="width:100%;">
		<tbody>
			<tr>
				...
				<th width="150" class="editTD"><input type="checkbox" onclick="allCheckEdit(this.checked);" class="editChk allCheckBoxEdit">
	...
	<div style="text-align:center;" class="shareBtnCls">
		<button style="border-radius: 2px; margin: 7px; border: none; font-size: 14px; padding: 9px 15px; display: inline-block; background: #297ACC; color: white;"onclick='shareUserSave();'>OK</button>
		<button style="border-radius: 2px; margin: 7px; border: none; font-size: 14px; padding: 9px 15px; display: inline-block; background: #6D808F; color: white;"onclick='shareClose();'>CANCEL</button>
	</div>
</body>
