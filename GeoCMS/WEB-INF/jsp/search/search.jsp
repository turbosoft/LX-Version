...
function addSearchDataCell(search, id, title, content, udate, file_url, thumbnail_url, origin_url, lat_arr, lon_arr, idx_arr, dataKind_arr) {
	...
	if(dataKind_arr=='GeoPhoto'){
		innerHTMLStr += "<img src='" + localAddress + "' width='140' height='110' hspace='10' vspace='10' border='3' style='border-color:white;'/>";
	}else if(dataKind_arr=='GeoVideo'){
		innerHTMLStr += "<img src='" + localAddress + "' width='140' height='110' hspace='10' vspace='10' border='3' style='border-color:white;'/>";
	}else{
		innerHTMLStr += "<img src='images/geoImg/blank(100x70).PNG' width='140' height='65' hspace='10' vspace='10' border='3' style='border-color:white;'/>";
	}

	innerHTMLStr += "</a>";
	img_cell.innerHTML = innerHTMLStr;
	var txt_cell1 = row.insertCell(-1);
	innerHTMLStr = "<div style='width:60px;'>&nbsp<label style='color:#000; font-size:12px;'><b>Target </b><br/><br/>&nbsp<b>Author <br/><br/>&nbsp<b>Title<br/><br/>";
	if(dataKind_arr == 'GeoPhoto' || dataKind_arr == 'GeoVideo'){
		innerHTMLStr += "&nbsp<b>Date </b></label></div>";
	}
	...
	innerHTMLStr = "<div style='width:140px;'>&nbsp<label style='color:#000; font-size:12px;'>"+search+"<br/><br/>&nbsp"+id+"<br/><br/>&nbsp"+title+"<br/><br/>";
	if(dataKind_arr == 'GeoPhoto' || dataKind_arr == 'GeoVideo'){
		innerHTMLStr += "&nbsp"+udate+"</label></div>";
	}
	...
	hr_cell.setAttribute('colspan', '3');
}
